package com.thaumcraft.aspects;
...
public class Aspect {
	...
	public Aspect(String tag, int color, Aspect[] components) {
		this(tag,color,components,new ResourceLocation("com/thaumcraft","textures/aspects/"+tag.toLowerCase()+".png"),1);
	}
	...
	public Aspect(String tag, int color, Aspect[] components, int blend) {
		this(tag,color,components,new ResourceLocation("com/thaumcraft","textures/aspects/"+tag.toLowerCase()+".png"),blend);
	}
